export default {
  ...
  settings: {
    ...
    ageYearsMonthsDays: '{years} yr {months} mo {days} d',
    ageYearsDays: '{years} yr {days} d',
  ...
  admin: {
    ...
    ingredientEdit: 'Edit Ingredient',
    ingredientName: 'Name (English)',
    ingredientNameUk: 'Name (Ukrainian)',
    ingredientCategory: 'Category',
    ingredientCalories: 'Calories per 100g',
    ingredientProtein: 'Protein per 100g',
    ingredientCarbs: 'Carbs per 100g',
    ingredientFat: 'Fat per 100g',
    ingredientFiber: 'Fiber per 100g',
    ingredientSugar: 'Sugar per 100g',
    ingredientImage: 'Image',
    ingredientSave: 'Save',
    ingredientDeleteConfirm: 'Delete this ingredient? This cannot be undone.',
  ...
  birthday: {
    ...
    messageToday: 'Today is {name}\'s special day! Wishing lots of joy and delicious food!',
    messageYesterday: 'Yesterday was {name}\'s birthday! Hope it was a wonderful day!',
    close: 'Thank you! 🎉',
  },
}
